      ...
      <main>
        ...
        <section className="community-sec">
          <div className="container">
            <div className="row">
              <h1 className="text-center text-light text-shadow">JobGenie Devs is the first community of software developers dedicated to making the job search easier.</h1>
              ...
              <div className="col-5 my-5">
                <iframe width="560" height="315" style={{ border: 'none' }} src="https://www.youtube.com/embed/oQX39Q3Lazs" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" ></iframe>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="find-job">
          <div className="container">
            <div className="row">
              <div className="col-6">
                <h3 className="">Find a job and be part of a community improving the job search.</h3>
                <p className="">Together we will build a better way for everyone to find jobs while helping you find yours.</p>
                <Link to='/signup' className="btn-own-outline d-block w-50 mx-auto ">Sign me Up</Link>
              </div>
