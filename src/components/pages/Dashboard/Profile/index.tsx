...
const Profile = () => {
  ...
  const handleSubmitUpdatePassword = (
    ...
    if (
      data.get("new_password") !== data.get("c_new_password") ||
      passwordLength < 8 ||
      !data.get("password")
    ) {
          ...
          <div className="container-fluid">
            <div className="row align-items-center ">
                      ...
                      <div className="media col-md-6">
                        ...
                        <p className="d-flex align-items-center">
                          ...
                          <Button
                            ...
                            className="user-edit-info text-danger"
                          >
                            Change <EditIcon />
                          </Button>
                        </p>
              ...
              <div className="userEdit-info">
                <Button onClick={handleOpen} className="user-edit-info">
                  Update Info <EditIcon />
                </Button>
