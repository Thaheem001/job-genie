    ...
    <>
      <div className="row w-100">
        ...
        <div className="col-12">
          <div className="row">
            ...
            <div className="col-md-4">
              {price && (
                ...
                >
                  Price {concatString ? `(${concatString})` : ""} :
                  <span className="text-danger2">${price}</span>
                </h3>
              )}
              {level && (
                <h3 className="level text-right text-capitalize ">
                  Level : <span className="text-danger2">{level}</span>
                </h3>
              )}
            </div>
          </div>
          ...
          <div className="date">
            <p className="float-right challenge-type">
              Challenge Type :{" "}
              <span className="text-capitalize text-danger2">{type}</span>
            </p>
          </div>
